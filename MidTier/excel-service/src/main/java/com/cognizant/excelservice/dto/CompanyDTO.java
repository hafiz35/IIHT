...
public class CompanyDTO {
	...
	public CompanyDTO(Integer id, String name, Double turnover, String ceo, String boardOfDirectors, String brief, Boolean active,
			String sector, List<CompanyStockExchangeDTO> stockCodes) {
		super();
		this.id = id;
		this.name = name;
